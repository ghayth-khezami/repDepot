...
export function MobileLayout() {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-lavender-50 dark:bg-slate-950">
      <header className="sticky top-0 z-40 flex items-center justify-between border-b border-primary-100 bg-white/90 px-4 py-3 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/90 pt-[max(0.75rem,env(safe-area-inset-top))]">
        <button
          type="button"

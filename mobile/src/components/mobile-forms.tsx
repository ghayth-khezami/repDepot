...
const inputClass =
  'mt-1 w-full rounded-xl border border-gray-200 px-4 py-3 dark:border-slate-600 dark:bg-slate-800';
...
export function PrimaryButton({
  ...
  return (
    <button
      ...
      className={`w-full rounded-2xl bg-primary-600 py-3.5 font-semibold text-white shadow-lg disabled:opacity-60 ${props.className ?? ''}`}
    >

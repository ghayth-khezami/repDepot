...
export class CreateProductDto {
  ...
  @ApiPropertyOptional({ description: 'Purchase price (required if not depot)', example: 699.99 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  PrixAchat?: number;
  ...
  @ApiPropertyOptional({ description: 'Depot percentage (0-100, required if depot)', example: 20 })
  @IsOptional()
  @IsNumber()
  @Min(0)

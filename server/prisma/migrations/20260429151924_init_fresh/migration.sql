...
CREATE TABLE "products" (
    ...
    "depotPercentage" DOUBLE PRECISION,
    "surcharge" DOUBLE PRECISION DEFAULT 0,
    "gain" DOUBLE PRECISION DEFAULT 0,
    "isDispo" BOOLEAN NOT NULL DEFAULT true,
    "coclientId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "user_likes_userId_productId_key" ON "user_likes"("userId", "productId");
...
-- AddForeignKey
ALTER TABLE "user_likes" ADD CONSTRAINT "user_likes_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
